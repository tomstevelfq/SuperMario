...
Outputs=Outputs\\
lfile=$(IDIR) $(LDIR) $(LIB)
ofile=$(Outputs)main.o $(Outputs)Mario.o $(Outputs)MapDesigner.o $(Outputs)Map.o $(Outputs)Brick.o $(Outputs)Global.o $(Outputs)Entity.o $(Outputs)Geezer.o $(Outputs)Turtle.o $(Outputs)Bullet.o $(Outputs)Treasure.o
$(target):$(ofile)
...
$(Outputs)Treasure.o:Treasure.cpp
	$(CC) Treasure.cpp $(lfile) -c -o $(Outputs)Treasure.o
clean:
	$(RM) $(ofile) main.exe
